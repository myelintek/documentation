...
docx:
	$(SPHINXBUILD) -b docx  . $(BUILDDIR)/docx
	@echo
	@echo "Build finished. The Word docx are in $(BUILDDIR)/docx."
...
livehtml:
	sphinx-autobuild --host 0.0.0.0 --port 4444 -b html $(ALLSPHINXOPTS) $(BUILDDIR)/html
